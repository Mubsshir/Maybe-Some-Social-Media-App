...
const Auth = () => {
  ...
  return (
    <div className="xl:w-1/3 phone:w-11/12 phone:mx-0  md:w-4/5 sm:w-4/5 sm:mx-auto h-auto  bg-white rounded-2xl overflow-auto xl:mt-3.5 xl:mr-28 backdrop-blur-lg drop-shadow-lg bg-opacity-5  ">
