...
const Article = (props) => {
  ...
  return (
    <>
            ...
            {props.pu_id == UID && (
              <div className="relative">
                ...
                {showOptions &&
                  ...
                  >
                    <button onClick={modalOpener}>Delete</button>
                  </MiniModal>
                }
              </div>
            )}
      ...
      {showModal && <Modal title="Warning" message="Do you want to delete this post" onYesClick={deleteHandler} />}
    </>
  )
}
...
Article.propTypes = {
  ...
  re_render:PropTypes.func.isRequired
};
